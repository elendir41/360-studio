...
import { DndContext, DragEndEvent, DragMoveEvent, useDroppable } from '@dnd-kit/core';
...
const Track = ({ trackId }: TrackProps) => {
  ...
  return (
    <DndContext id={useId()} modifiers={[restrictToHorizontalAxis, restrictToParentElement]} onDragMove={handleDragMove} onDragEnd={handleDragEnd}>
